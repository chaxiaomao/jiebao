<?php
defined('JB_THEME_1') or define('JB_THEME_1', 'jiebao');
...
return [
    ...
    'components' => [
        'view' => [
            'theme' => [
                'basePath' => '@app/themes/' . JB_THEME_1,
                'baseUrl' => '@web/themes/' . JB_THEME_1,
                'pathMap' => [
                    '@app/views' => ['@app/themes/' . JB_THEME_1,],
                    '@app/modules' => '@app/themes/' . JB_THEME_1 . '/modules', // module's theme
                    '@app/widgets' => '@app/themes/' . JB_THEME_1 . '/widgets', // widget's theme
                ],
            ],
        ],
        'user' => [
        ...
        'log' => [
            ...
            'targets' => [
                ...
                [
                    ...
                    'message' => [
                        'to' => ['1145470390@qq.com'],//当触发levels配置的错误级别时，发送到此些邮箱（请改成自己的邮箱）
